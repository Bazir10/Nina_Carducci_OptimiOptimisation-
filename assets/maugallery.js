(function($) {
  ...
  $.fn.mauGallery.methods = {
      ...
      prevImage(lightboxId) {
          ...
          let $prevImage = $currentImage.parents('.item-column').prev().find('.gallery-item');
      ...
      nextImage(lightboxId) {
          let $currentImage = $(`#${lightboxId}`).data("currentImage");
          let $nextImage = $currentImage.parents('.item-column').next().find('.gallery-item');
                  ...
                  <div class="modal-dialog modal-dialog-centered" role="document">
                      <div class="modal-content">
                          <div class="modal-body">
                              ...
                              ${
                                  navigation
                                      ? '<div class="mg-prev" style="cursor:pointer;position:absolute;top:50%;left:-15px;">&lt;</div>'
                                      : '<span style="display:none;" />'
                              }
                              <img class="lightboxImage img-fluid" alt="Contenu de l\'image affichée dans la modale au clique"/>
                              ${
                                  navigation
                                      ? '<div class="mg-next" style="cursor:pointer;position:absolute;top:50%;right:-15px;">&gt;</div>'
                                      : '<span style="display:none;" />'
                              }
                          </div>
                      </div>
